...
export const PLATFORM_PRESETS: PlatformPreset[] = [
  ...
  },
  {
    ...
    use_proxies: true,
    repeat: true,
    description: "Watch + recommandations",
    actions: [
      wait(4000),
      scrollDown(4, 700),
      { type: "click", selector: "a.video-item--a", count: 1, delay_ms: 600 },
      wait(12000),
      scrollDown(3, 800),
    ],
  },
  {
    ...
    use_proxies: true,
    repeat: true,
    description: "Watch + feed vidéo",
    actions: [
      wait(3000),
      scrollDown(4, 600),
      { type: "click", selector: "a[data-testid='video-card']", count: 1, delay_ms: 600 },
      wait(10000),
    ],
  },
  {
    ...
    use_proxies: true,
    repeat: true,
    description: "Scroll infini + saves",
    actions: [
      wait(2000),
      scrollDown(6, 500),
      { type: "click", selector: "div[data-test-id='pin'] a", count: 1, delay_ms: 600 },
      wait(3000),
      scrollDown(6, 500),
    ],
  },
  {
    ...
    use_proxies: true,
    repeat: true,
    description: "Feed pro + posts",
    actions: [
      wait(2500),
      scrollDown(5, 700),
      { type: "click", selector: "button[aria-label*='Like']", count: 1, delay_ms: 800 },
      wait(2000),
      scrollDown(5, 700),
    ],
  },
  {
    ...
    use_proxies: true,
    repeat: true,
    description: "Canaux + previews",
    actions: [
      wait(2000),
      scrollDown(4, 600),
      { type: "click", selector: "a.tme-channel-card", count: 1, delay_ms: 600 },
      wait(4000),
    ],
  },
  {
    ...
    use_proxies: true,
    repeat: true,
    description: "Fiches jeux + reviews",
    actions: [
      wait(2000),
      scrollDown(4, 600),
      { type: "click", selector: "a.search_result_row", count: 1, delay_ms: 600 },
      wait(4000),
      scrollDown(3, 700),
    ],
  },
